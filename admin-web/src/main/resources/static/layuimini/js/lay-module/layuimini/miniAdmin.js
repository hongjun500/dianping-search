    ...
    var miniAdmin = {
        ...
        render: function (options) {
            ...
            $.getJSON(options.iniUrl, function (data) {
                console.log(data)
                console.log(data.homeInfo.title)
                console.log(data.logoInfo.title)
                if (data == null) {
        ...
        renderLogo: function (data) {
           /* console.log(data)
            var html = '<a href="' + "#" + '"><img src="' + data.image + '" alt="logo"><h1>' + data.title + '</h1></a>';
            $('.layuimini-logo').html(html);*/
            var image='';
            var style='';
            if(data.image){
                image='<img src="' + data.image + '" alt="logo">';
            }else{
                style='margin: 0 0 0 0px';
            }
            var html = '<a href="' + data.href + '">'+image+'<h1 style="'+style+'">' + data.title + '</h1></a>';
            $('.layuimini-logo').html(html);
        },
